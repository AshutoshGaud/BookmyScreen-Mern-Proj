...
import { MdChair } from 'react-icons/md'   // ✅ FIX: Added this import
  ...
  return (
    <div className='px-6 rounded-md'>
      ...
      {ordersData.map((order) => (
        <div key={order.id} className='bg-white p-5 rounded-md mb-4 overflow-hidden'>
          <div className='flex items-start gap-10'>
            <img src={order.poster} alt='' className='w-30 h-40 object-cover rounded' />

            {/* Divider */}
            <div className='h-40 border border-gray-300 border-dashed'></div>
